...
/*
 ...
 - 2017/12/21 (1.53) - ImDrawList: removed 'bool anti_aliased = false' final parameter of ImDrawList::AddPolyline() and ImDrawList::AddConvexPolyFilled(). Prefer manipulating ImDrawList::Flags if you need to toggle them during the frame.
...
ImGuiStyle::ImGuiStyle()
{
    ...
    ItemSpacing             = ImVec2(6,6);      // Horizontal and vertical spacing between widgets/lines
    ItemInnerSpacing        = ImVec2(6,6);      // Horizontal and vertical spacing between within elements of a composed widget (e.g. a slider and its label)
